"""Agent Engine multi-agent system for testing BQ Agent Analytics Plugin.
...
This version uses os.environ for project config so it works on Agent Engine.
"""
...
bq_config = BigQueryToolConfig(
    ...
    application_name="bq_analytics_test_remote",
)
...
bq_analytics_plugin = BigQueryAgentAnalyticsPlugin(
    ...
    config=BigQueryLoggerConfig(
        ...
        custom_tags={
            "env": "agent_engine",
            "test": "eventdata_refactor",
        },
    ),
)

app = App(
    name="bq_analytics_test_remote",
